...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        createUserJButton.setForeground(new java.awt.Color(255, 102, 204));
        ...
        passwordJTextField.setForeground(new java.awt.Color(255, 102, 204));

        jLabel3.setForeground(new java.awt.Color(255, 102, 204));
        jLabel3.setText("Employee");

        employeeJComboBox.setForeground(new java.awt.Color(255, 102, 204));
        employeeJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        backjButton1.setBackground(new java.awt.Color(204, 204, 204));
        backjButton1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        backjButton1.setForeground(new java.awt.Color(255, 102, 204));
        ...
        roleJComboBox.setForeground(new java.awt.Color(255, 102, 204));
        roleJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        btndelete.setForeground(new java.awt.Color(255, 102, 204));
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if (selectedRow >= 0 ){
            UserAccount sel = (UserAccount) userJTable.getValueAt(selectedRow,0);
        ...
        for (Organization og : enterprise.getOrganizationDirectory().getOrganizationList()) {
            ...
            og.getUserAccountDirectory().getUserAccountList().remove(sel);
        }
        }
        popData();
        // TODO add your handling code here:
